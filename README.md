...
![Example CPT-based probabilistic liquefaction output](CPT_profile_panels.png)

**Example output.** Depth-dependent CPT profile generated by the probabilistic liquefaction-triggering workflow, showing **q<sub>c</sub>**, **R<sub>f</sub>**, **I<sub>c,RW</sub>**, **ψ**, **CRR(ψ)**, and **P<sub>L</sub>**.
